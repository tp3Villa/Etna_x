...
namespace ETNA.SGI.Presentacion.Formularios.Exportacion
{
    public partial class frmAprobacionSolicitud : Form
    {
        ...
        private void frmAprobacionSolicitud_Load(object sender, EventArgs e)
        {
            ...
            //objBus = new BTablas();
            dtSolicitud = FabricaNeg._instancia().ObtenerTablas().BConsula_Aprobacion_Solicitudes("A", "P", "0", "0", 0);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.GridColor = Color.Red;
            //objBus = new BTablas();
            dtSolicitud = FabricaNeg._instancia().ObtenerTablas().BConsula_Aprobacion_Solicitudes("A", "P", Desde, hasta, 1);
            dataGridView1.DataSource = dtSolicitud;
        }
