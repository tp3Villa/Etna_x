...
namespace ETNA.SGI.Presentacion.Formularios.Exportacion
{
    public partial class frmBusquedaFormatoComercial : Form
    {
        ...
        private void frmBusquedaFormatoComercial_Load(object sender, EventArgs e)
        {
            ...
            dtDocVersiones = FabricaNeg._instancia().ObtenerTablas().BConsula_Versiones_Documentos_Detalle(0, "", "", "", 0);
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            dtDocVersiones = FabricaNeg._instancia().ObtenerTablas().BConsula_Versiones_Documentos_Detalle(Convert.ToInt16(tipo), estado, Desde, hasta, 1);
            dgvVersiones.DataSource = dtDocVersiones;
